...
class DynamicFormTest < ActionView::TestCase
  ...
  def test_form_with_protect_against_forgery
    ...
    assert_dom_equal(
      %(<form action="create" method="post" accept-charset="UTF-8"><div style="margin:0;padding:0;display:inline"><input name="_snowman" value="&#9731;" type="hidden" /><input type='hidden' name='authenticity_token' value='123' /></div><p><label for="post_title">Title</label><br /><input id="post_title" name="post[title]" size="30" type="text" value="Hello World" /></p>\n<p><label for="post_body">Body</label><br /><div class="field_with_errors"><textarea cols="40" id="post_body" name="post[body]" rows="20">Back to the hill and over it again!</textarea></div></p><input name="commit" type="submit" value="Create" /></form>),
      form("post")
    )
  end
  ...
  def test_form_with_method_option
    assert_dom_equal(
      %(<form action="create" method="get" accept-charset="UTF-8"><div style="margin:0;padding:0;display:inline"><input name="_snowman" value="&#9731;" type="hidden" /></div><p><label for="post_title">Title</label><br /><input id="post_title" name="post[title]" size="30" type="text" value="Hello World" /></p>\n<p><label for="post_body">Body</label><br /><div class="field_with_errors"><textarea cols="40" id="post_body" name="post[body]" rows="20">Back to the hill and over it again!</textarea></div></p><input name="commit" type="submit" value="Create" /></form>),
  ...
  def test_form_with_string_multipart
    assert_dom_equal(
      %(<form action="create" enctype="multipart/form-data" method="post" accept-charset=\"UTF-8\"><div style=\"margin:0;padding:0;display:inline\"><input name=\"_snowman\" value=\"&#9731;\" type=\"hidden\" /></div><p><label for="post_title">Title</label><br /><input id="post_title" name="post[title]" size="30" type="text" value="Hello World" /></p>\n<p><label for="post_body">Body</label><br /><div class="field_with_errors"><textarea cols="40" id="post_body" name="post[body]" rows="20">Back to the hill and over it again!</textarea></div></p><input name="commit" type="submit" value="Create" /></form>),
  ...
  def test_default_form_builder_with_dynamic_form_helpers
    ...
    expected = %(<form class="post_new" method="post" action="" id="post_new" accept-charset=\"UTF-8\"><div style=\"margin:0;padding:0;display:inline\"><input name=\"_snowman\" value=\"&#9731;\" type=\"hidden\" /></div>) +
